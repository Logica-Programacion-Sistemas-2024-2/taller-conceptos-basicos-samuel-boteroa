...
public class App {
    ...
    public static String convertirVelocidad(double kmPorSeg) {
        try {
            double metrosSeg = kmPorSeg*1000;
            double metrosHora = metrosSeg*3600;
            return (long) metrosSeg +"|"+ (long) metrosHora;
        } catch (Exception e) {
            return "0|0";
        }
    }
    ...
    public static int convertirATotalSegundos(int dias, int horas, int minutos, int segundos) {
        try {
            int convertirDias = dias*(3600*24);
            int convertirHoras = horas*3600;
            int convetirMinutos = minutos*60;
            return convertirDias+convertirHoras+convetirMinutos+segundos; 
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    public static String calcularPesoNeto(double peso) {
        try {
            double kg = peso / 1000;
            double tonelada = kg / 1000;
            return (long) kg + "|" + (long) tonelada;
        } catch (Exception e) {
            return "0|0";
        } 
    ...
    public static int calcularTiempoViaje(double distancia, double velocidadKilometros, double velocidadHora) {
        try {
            if(distancia == 0.0|| velocidadKilometros == 0.0 || velocidadHora == 0.0){
                return -1;
            }
    ...
    //El piloto desea un algoritmo que ingresando 4 rutas y el kilometraje de cada ruta obtenga la cantidad de combustible que debe tanquear en el avión.
    public static double combustibleRuta(double ruta){
        double gasolinaRuta = (ruta*0.2)/60.8;
        gasolinaRuta = gasolinaRuta + 1.6;
        return gasolinaRuta;
    }
    public static int calcularCombustible(double ruta1, double ruta2, double ruta3, double ruta4) {
        try {
            return (int)(combustibleRuta(ruta1)+combustibleRuta(ruta2)+combustibleRuta(ruta3)+combustibleRuta(ruta4));
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    public static int calcularPesoLunar(double pesoTierra) {
        try {
            double porcentajeLunar = pesoTierra* 0.17;
            return(int) (pesoTierra +porcentajeLunar);
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    public static String calcularCuentaRestaurante(double costoComida) {
        try {
            ...
            double costoFinal = costoComida + impuesto + propina; 
            return (int)propina +"|"+(int)impuesto+"|"+ (int)costoFinal;
        } catch (Exception e) {
            return -1 + "|" + -1 + "|" + -1;
        }
    }

    // Diseñar un algoritmo que obtenga los puntos finales de un equipo de fútbol (puntuación según lineamientos de Fifa) a 
    // partir de los datos ingresados por teclado: Número de partidos ganados número de partidos perdidos número de partidos empatados.
    ...
    public static int calcularNotaFinal(double nota1, double nota2, double nota3, double nota4, double nota5,
        ...
        try {
            if(nota1 == 0 ||nota2 == 0 ||nota3 == 0 ||nota4 == 0 ||nota5 == 0 ||porcentaje1 == 0 ||porcentaje2 == 0 ||porcentaje3 == 0 ||porcentaje4 == 0 ||porcentaje5 == 0){
                return -1;
            }
            return (int) ((nota1*porcentaje1)+(nota2*porcentaje2)+(nota3*porcentaje3)+(nota4*porcentaje4)+(nota5*porcentaje5));
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    public static int calcularNotaNecesaria(double porcentaje1, double porcentaje2, double porcentaje3, double porcentaje4, double porcentaje5, double nota1, double nota2, double nota3, double nota4) {
        try {
            double notaActual =(nota1*porcentaje1)+(nota2*porcentaje2)+(nota3*porcentaje3)+(nota4*porcentaje4);
            double notaNecesaria = 5-notaActual;
    ...
    //cantidad de horas normales laboradas cantidad de horas extras diurnas laboradas cantidad de horas extras nocturnas laboradas valor de la hora normal. 
    //El valor de las horas extras diurnas tienen un recargo adicional del 15% sobre la hora normal. El valor de las horas extras nocturnas tienen un recargo a
    //dicional del 35% sobre la hora normal.
